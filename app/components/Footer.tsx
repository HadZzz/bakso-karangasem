        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="col-span-1 md:col-span-2">
            ...
            <p className="text-gray-300 mb-6 leading-relaxed">
              Bakso legendaris dengan cita rasa autentik yang telah menjadi favorit keluarga 
              di Karangasem, Sukoharjo selama puluhan tahun. Dibuat dengan resep turun temurun 
              dan bahan-bahan berkualitas terbaik.
            </p>
            <div className="flex space-x-4">
              <a 
                href="https://instagram.com/baksomurniati" 
                target="_blank" 
              ...
              <a 
                href="https://facebook.com/baksomurniati" 
                target="_blank" 
                rel="noopener noreferrer"
          ...
          <div>
            ...
            <div className="space-y-3">
              ...
              <div className="flex items-center space-x-3">
                ...
                <p className="text-gray-300 text-sm">(0271) 123-4567</p>
              </div>
        ...
        <div className="border-t border-gray-800 mt-12 pt-8">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <p className="text-gray-400 text-sm mb-4 md:mb-0">
              © {currentYear} Bakso Murniati. Semua hak cipta dilindungi.
            </p>
