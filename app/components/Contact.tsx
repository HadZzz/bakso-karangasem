...
export default function Contact() {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    const whatsappMessage = `Halo Bakso Murniati!%0A%0ANama: ${formData.name}%0AEmail: ${formData.email}%0ATelepon: ${formData.phone}%0A%0APesan: ${formData.message}`;
    window.open(`https://wa.me/62085876120167?text=${whatsappMessage}`, '_blank');
  };
          ...
          <div className="space-y-8">
            <div>
              ...
              <p className="text-gray-600 mb-8">
                Kami siap melayani Anda dengan sepenuh hati. Hubungi kami melalui berbagai channel berikut:
              </p>
            </div>
              ...
              <div className="bg-white border border-gray-200 p-6 rounded-2xl shadow-sm hover:shadow-md transition-shadow">
                <div className="flex items-center space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">+62 858-7612-0167</p>
              ...
              <div className="bg-white border border-gray-200 p-6 rounded-2xl shadow-sm hover:shadow-md transition-shadow">
                <div className="flex items-center space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">@baksomurniati</p>
                    <p className="text-sm text-gray-500">Follow untuk update menu terbaru</p>
                  </div>
                </div>
              </div>
              ...
              <div className="bg-white border border-gray-200 p-6 rounded-2xl shadow-sm hover:shadow-md transition-shadow">
                <div className="flex items-center space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">hadzipamuji5@gmail.com</p>
                    <p className="text-sm text-gray-500">Untuk kerjasama dan pertanyaan umum</p>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="bg-red-50 p-6 rounded-2xl">
              ...
              <div className="grid grid-cols-2 gap-4">
                ...
                <a
                  ...
                  className="bg-green-500 hover:bg-green-600 text-white text-center py-3 px-4 rounded-lg transition-colors"
                >
                  Chat WhatsApp
                </a>
              </div>
